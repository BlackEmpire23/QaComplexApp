...
class TestLoginPage(BaseTest):
    ...
    def test_username_on_registration_filed(self, driver):
        ...
        6. Clear this field, type some text then clear this field - checking empty fields.
        """
        ...
        # 2. Type to field 1 or 2 symbols(letters or numbers).
        base_helper.fill_input_field(by=By.XPATH,
    ...
    def test_successful_registration(self, driver):
        ...
        login_helper.registration(username=username, email=email, password=password)
        # 3. Verify result.
